...
public class PhoneOTp_donor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_phone_otp_donor);

        otpInput=findViewById(R.id.phoneLoginOtp_donor);
        loginbtn_phone=findViewById(R.id.phoneOtPNext_btn_donor);
        pgbar_phone=findViewById(R.id.pgBar_phone);
        resendOTPbtn=findViewById(R.id.phoneOtpResendbtn_donor);
        resendOTPTimertextview=findViewById(R.id.phoneOtpTextview_donor);
        ...
        loginbtn_phone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String enteredOTP_Donor=otpInput.getText().toString();
                PhoneAuthCredential credential=PhoneAuthProvider.getCredential(verificationCode,enteredOTP_Donor);
                signIn(credential);
            }
        });
        ...
        mauth.signInWithCredential(phoneAuthCredential).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if(task.isSuccessful()){
                    ...
                    Intent inext=new Intent(PhoneOTp_donor.this, Donor_panel_bottomNavigationview.class);
                    startActivity(inext);
                    finish();
